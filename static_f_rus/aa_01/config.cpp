...
{
	class I_static_AA_F;
	class I_RU_Static_AA_F: I_static_AA_F
	{
		...
		editorPreview="\A3\EditorPreviews_F_Rus\Data\CfgVehicles\I_RU_Static_AA_F.jpg";
		_generalMacro="I_RU_Static_AA_F";
