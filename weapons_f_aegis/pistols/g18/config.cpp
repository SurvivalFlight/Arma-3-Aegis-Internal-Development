class CfgPatches
{
	class A3_Weapons_F_Aegis_Pistols_G18
	{
		...
		units[]=
		{
			"Weapon_hgun_G18_blk_F",
			"Weapon_hgun_G18_F",
			"Weapon_hgun_G18_khk_F"
		};
		weapons[]=
		{
			"hgun_G18_blk_F",
...
class CfgWeapons
{
	...
	class hgun_G18_F: Pistol_Base_F
	{
		...
		_generalMacro="hgun_G18_F";
		baseWeapon="hgun_G18_F";
		scope=2;
	...
	class hgun_G18_khk_F: hgun_G18_F
	{
		author="$STR_A3_Night515";
		_generalMacro="hgun_G18_khk_F";
		baseWeapon="hgun_G18_khk_F";
		displayname="G18 9 mm (Khaki)";
		hiddenSelectionsTextures[]=
		{
	...
	class hgun_G18_blk_F: hgun_G18_F
	{
		author="$STR_A3_Night515";
		_generalMacro="hgun_G18_blk_F";
		baseWeapon="hgun_G18_blk_F";
		displayName="G18 9 mm (Black)";
		hiddenSelectionsTextures[]=
		{
...
{
	class Weapon_Base_F;
	class Weapon_hgun_G18_F: Weapon_Base_F
	{
		scope=2;
		scopeCurator=2;
		displayname="G18 9 mm";
	...
	class Weapon_hgun_G18_khk_F: Weapon_Base_F
	{
		scope=2;
		scopeCurator=2;
		displayname="G18 9 mm (Khaki)";
		...
		class TransportWeapons
		{
			class _xx_hgun_G18_khk_F
			{
				weapon="hgun_G18_khk_F";
				count=1;
			};
		};
		class TransportMagazines
	...
	class Weapon_hgun_G18_blk_F: Weapon_Base_F
	{
		scope=2;
		scopeCurator=2;
		displayName="G18 9 mm (Black)";
		...
		class TransportWeapons
		{
			class _xx_hgun_G18_blk_F
			{
				weapon="hgun_G18_blk_F";
				count=1;
			};
		};
		class TransportMagazines
